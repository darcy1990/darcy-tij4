...
public class TestArrayGeneration {
	public static void main(String[] args) {
		...
		BigDecimal[] a9 = Generated.array(BigDecimal.class,
				new RandomGenerator.BigDemical(), size);
		print("a9 = " + Arrays.toString(a9));
	}
} /*
 * Output: a1 = [true, false, true, false, false, true] a2 = [104, -79, -76,
 * 126, 33, -64] a3 = [Z, n, T, c, Q, r] a4 = [-13408, 22612, 15401, 15161,
 * -28466, -12603] a5 = [7704, 7383, 7706, 575, 8410, 6342] a6 = [7674, 8804,
 * 8950, 7826, 4322, 896] a7 = [0.01, 0.2, 0.4, 0.79, 0.27, 0.45] a8 = [0.16,
 * 0.87, 0.7, 0.66, 0.87, 0.59]
 */// :~
